...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/FirstStepzz/PodTestLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'FirstStepzz' => 'zhixiong@inconnecting.com' }
  s.source           = { :git => 'https://github.com/FirstStepzz/PodTestLibrary.git', :tag => s.version.to_s }
